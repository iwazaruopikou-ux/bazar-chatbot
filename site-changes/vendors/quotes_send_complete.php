...
$bread = array(
  SSL_URL."vendors/quotes_search.php" => META_VENDORS_QUOTES_SEARCH,
...
<div class="wrap3">
<div class="wrap">
<?php require_once TEMP_DIR.'/header.php'; ?>
...
<?php if (isset($_GET['msg']) && $_GET['msg'] == 1) : ?>
    ...
    <div style="font-size:105%;">
      ...
      <p style="font-size:150%"><b>ハウジングバザール資料請求サービスをご利用頂きまして、有難うございました。ご登録された入力内容について、ご連絡させて頂く場合がございます。電話番号はこちらです▶︎<span style="color:#ff3300;font-size:120%;">0436-63-3015</span><br />
      またご不明な点などありましたら、上記の番号でご連絡を受け付けております。
      </b></p>

      <!--
      <div style="text-align:center;margin:20px 0 10px 0;">
      <img src="<?=SSL_URL?>images/affili.png">
      </div>

      <b> <p   style="font-size:150%;">私たちのサービスをアフィリエイターとしてPRして下さる方を募集しています！ご紹介頂いた方に、成果報酬をお支払いしています。<br  />ブログやウェブサイトをお持ちの方、是非ご登録下さい！</p></b>

      <div style="text-align:center;margin:0 0 40px 0;">
      <a href="https://omoikanebooks.wixsite.com/bazaraffiliate"><img src="<?=SSL_URL?>images/affili_button.png"></a>
      </div>
      -->

      <img src="<?=SSL_URL?>vendors/images/ikkatsu_thanks_line.png">
      <div style="text-align:center;">
      <a href="https://lin.ee/7tw75mU"><img src="https://scdn.line-apps.com/n/line_add_friends/btn/ja.png" alt="友だち追加" height="60" border="0"></a><br />
        <img src="<?=SSL_URL?>images/S_gainfriends_2dbarcodes_BW.png" alt="友だち追加QR" height="70px" style="padding:20px 0 10px;">
      </div>
...
<?php else : ?>
    ...
    <p class="thanks">
      ご利用ありがとうございます。<br />
      <br />
      ご入力内容について、電話等で確認させて頂く事がございますのでどうぞ宜しくお願い致します。<br />
      <br />
      改めまして、この度はハウジングバザールをご利用頂きまして誠にありがとうございます。
    </p>
